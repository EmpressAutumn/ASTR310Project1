...
#calibrate_science_images("20250908_07in_NGC6946", 11, "g'")
...
#calibrate_science_images("20251003_07in_NGC6946", 13, "ha", "LIGHT_NGC 6946_")
...
def final_shift(image_folders, filter_name):
    ...
    for i in range(len(image_folders)):
        ...
        # Shift the image
        image = imshift(image, int(shifts[f"{image_folders[i]}-{filter_name}"][2]), int(shifts[f"{image_folders[i]}-{filter_name}"][1]))
...
final_shift(["20250908_07in_NGC6946","20250928_07in_NGC6946","20251015_07in_NGC6946"],"g'")
final_shift(["20250928_07in_NGC6946", "20251003_07in_NGC6946","20251009_07in_NGC6946","20251015_07in_NGC6946"], "ha")   
